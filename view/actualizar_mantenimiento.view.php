...
<body>
    <form method="POST" action="index.php?vista=mantenimiento&accion=actualizar&id=<?= $mantenimiento['id'] ?>">
        ...
        <input type="date" name="ultimo_mantenimiento" id="fecha_mantenimiento"
               value="<?= htmlspecialchars($mantenimiento['ultimo_mantenimiento']) ?>" required>

        <label for="descripcion">Descripción:</label>
        <textarea name="descripcion" id="descripcion" required><?= htmlspecialchars($mantenimiento['descripcion']) ?></textarea>
